...
const menus = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 4, name: "twitter", href: "/twitter" },
    ],
  },
];
...
function Footer() {
  return (
    <div className="w-full text-text h-[100px] mt-28">
      <div className="xl:max-w-5xl mx-auto flex xl:flex-row xl:space-x-20 px-10 xl:px-0 xl:justify-between flex-col items-center md:items-start xl:space-y-0 space-y-8">
        <h1 className="text-[20px] w-fit uppercase font-[600] leading-[27.5px]">
          Krypto
        </h1>

        <div className="flex-row flex items-start space-x-16 justify-start content-start">
          {menus.map((menu) => (
            <span
