            ...
            <div className="flex flex-col">
              <div className="mt-10  fle mb-10">
                ...
                <p className="text-xl mt-10">
                  ...
                  pandangan masyarakat terhadap botol air minum sekali pakai.
                  Kami percaya bahwa setiap botol dapat memiliki nilai yang lebih dari sekadar pembuangannya,
                  dan kami berkomitmen untuk merubahnya menjadi aset bernilai yang membawa manfaat bagi lingkungan dan komunitas, di bantu dengan Fitur Fitur yang ada di Klora.
                </p>
